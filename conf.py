...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny Mobile Application Framework} }{\tiny © 2021 Envision Digital. All Rights Reserved.}}}
    ...
    'maketitle': r'''
        ...
        \begin{titlepage}
            ...
            \fontsize{30pt}{\baselineskip}\selectfont \textbf{Mobile Application Framework}

            \vspace{5mm}

            \huge \textmd{Version}\textbf{ dev}
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'Mobile Application Framework',
...
man_pages = [
    (master_doc, u'enosdocumentationcenter', u'Mobile Application Framework',
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'Mobile Application Framework',
